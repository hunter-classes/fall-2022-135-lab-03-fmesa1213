...
* Notes: I understood the main lab instuctuctions, but I got lost on how to make other files and attach them to other ones. This was the same problem I had with the last lab. I would really like to set up an appoinment with you so I could be able to speak with you one-on-one.
